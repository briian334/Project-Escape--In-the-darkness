...
public class sensor : MonoBehaviour
{
    ...
    public float minDistanceRangeDetect = 1.0f;
    ...
    public bool IsInSight(GameObject obj)
    {
        ...
        // CAMPO DE VISION 360 GRADOS        
        if (Vector3.Distance(origin, dest) < minDistanceRangeDetect)
        {
            Debug.Log("¡Demasiado cerca!");
            GameManager.Instance.FnPlayerDie();
        }
        direction.y = 0f;
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(transform.position, minDistanceRangeDetect);
    }
}
